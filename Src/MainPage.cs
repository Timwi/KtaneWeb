...
namespace KtaneWeb
{
    public sealed partial class KtanePropellerModule
    {
        ...
        static readonly KtaneFilter[] _filters = Ut.NewArray(
            ...
            KtaneFilter.BooleanSet("Pseudo-Needy Status", "pseudoneedystatus", new[] { new KtaneFilterOption { Name = "NotPseudoNeedy", ReadableName = "Not Pseudo-Needy" }, new KtaneFilterOption { Name = "IsPseudoNeedy", ReadableName = "Pseudo-Needy" }, new KtaneFilterOption { Name = "IsHeavyTimeDepend", ReadableName = "Heavily time-dependent" } }, mod => mod.IsPseudoNeedy ? "IsPseudoNeedy" : mod.IsHeavyTimeDepend ? "IsHeavyTimeDepend" : "NotPseudoNeedy", $@"mod=>mod.IsPseudoNeedy?""IsPseudoNeedy"":mod.IsHeavyTimeDepend?""IsHeavyTimeDepend"":""NotPseudoNeedy"""));
