...
namespace KtaneWeb
{
    public sealed partial class KtanePropellerModule
    {
        ...
        private (string filename, bool wasGenerated) generatePdf(string htmlFile)
        {
            var cache = getModuleInfoCache();
            ...
            try
            {
                ...
                foreach (var module in matchingModules)
                {
                    ...
                    if (fullPath.EndsWith(".html") && File.Exists(fullPath))
                    {
                        ...
                        {
                            var (pdfFilename, pdfGenerated) = generatePdf(fullPath);
                            if (pdfGenerated)
                                generated++;
