                    ...
                    new DIV { id = "main-content" }._(
                        ...
                        new DIV { id = "links", class_ = "popup disappear stay" }._(
                            ...
                            new UL { class_ = "below-icons" }._(
                                ...
                                new LI(new A { href = "https://ktanewhocansolve.com/", title = translation.whoCanSolveMaintainer }._(translation.whoCanSolveAnchor)),
                        ...
                        new DIV { id = "more", class_ = "popup disappear stay" }._(
                            ...
                            new TABLE { class_ = "file-locations" }._(
                                ...
                                new TR(new TH(translation.fileLocationScreenshot + " (Steam):"), new TD(new INPUT { type = itype.text, class_ = "select-on-focus", value = @"~/.var/app/com.valvesoftware.Steam/.steam/steam/userdata/<some number>/760/remote/341800/screenshots" }))),
